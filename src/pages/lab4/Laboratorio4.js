    ...
    return (
        <div className="max-w-5xl mx-auto p-8 space-y-10 bg-white rounded-3xl shadow-xl">
            <header className="text-center space-y-2">
                <h1 className="text-5xl font-extrabold text-indigo-700">Laboratorio 4</h1>
                <p className="text-gray-600 text-lg">Descripción detallada del Laboratorio 4.</p>
                <p className="text-sm text-gray-500">
                    <span className="font-semibold">Fecha:</span> 01/01/2025
                </p>
            </header>
