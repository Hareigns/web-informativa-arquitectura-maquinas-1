  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <header className="text-center">
        <h1 className="text-4xl font-bold text-blue-600 mb-2">Laboratorio 3</h1>
        <p className="text-gray-700">Descripción detallada del Laboratorio 3.</p>
        <p className="text-sm text-gray-500"><strong>Fecha:</strong> 01/01/2025</p>
      </header>
