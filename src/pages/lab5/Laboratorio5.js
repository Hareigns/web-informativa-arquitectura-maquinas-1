...
const Laboratorio5 = () => {
  return (
        <div className="container text-center">
            <h1>Laboratorio 5</h1>
            <p>Descripción detallada del Laboratorio 5.</p>
            ...
            <Link to="/lab5/Ensamblador-Familiax86">
                <button className="btn btn-primary mt-3">Ver Infografía sobre Ensamblador Familiax86</button>
            </Link>
        </div>
    );
};
